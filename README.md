...
4.  Allow changing A = 440 hz to different values
5.  Global filter controls
6.  Pattern presets/save/load
7.  More precise timing options (swing, triplets)
8.  Adding tests, I suppose? 
